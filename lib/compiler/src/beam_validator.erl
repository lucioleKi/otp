...
vi({put_record,{f,0},Id,Src,Dst,Live,{list,List}}, Vst) ->
    %% Update a native record. Generated by OTP 29.
    verify_update_native_record_r29(Id, Src, Dst, Live, List, Vst);
...
verify_update_native_record_r29(Id, Src, Dst, Live, List, Vst0) ->
    assert_term(Src, Vst0),
    verify_live(Live, Vst0),
    verify_y_init(Vst0),
