...
%% =====================================================================
-doc "Algorithm specific internal state".
-nominal exsplus_state() :: nonempty_improper_list(uint58(), uint58()).
...
-doc "Algorithm specific internal state".
-nominal exs1024_state() :: {list(uint64()), list(uint64())}.
...
-doc "Algorithm specific internal state".
-nominal exro928_state() :: {list(uint58()), list(uint58())}.
...
-doc "Algorithm specific internal state".
-nominal exrop_state() :: nonempty_improper_list(uint58(), uint58()).
